<p align="center">
  <img src="docs/tarkovy-banner.png" alt="Tarkovy — by Anomaly Labs" width="920"/>
</p>

<p align="center">
  <img src="docs/tarkovy-icon.png" alt="Tarkovy icon" width="72"/>
</p>

<h1 align="center">TARKOVY</h1>

<p align="center">
  <strong>Minimap overlay companion for Escape from Tarkov</strong><br/>
  by <strong>Anomaly Labs</strong>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/version-Dev%200.0.1-111111?style=flat-square&labelColor=000000" alt="Dev 0.0.1"/>
  <img src="https://img.shields.io/badge/platform-Windows%2010%2F11-111111?style=flat-square&labelColor=000000" alt="Windows"/>
  <img src="https://img.shields.io/badge/.NET-8%20WPF-111111?style=flat-square&labelColor=000000" alt=".NET 8"/>
  <img src="https://img.shields.io/badge/by-Anomaly%20Labs-111111?style=flat-square&labelColor=000000" alt="Anomaly Labs"/>
</p>
...
<p align="center">
  <img src="docs/tarkovy-app.png" alt="Tarkovy app screenshot" width="920"/>
</p>

<p align="center"><em>Main window — map preview, markers, and controls · Anomaly Labs</em></p>

<p align="center">
  <img src="docs/tarkovy-logo.png" alt="Tarkovy logo" width="420"/>
</p>
...
| Asset | Path |
| --- | --- |
| Banner | [`docs/tarkovy-banner.png`](docs/tarkovy-banner.png) |
| Screenshot | [`docs/tarkovy-app.png`](docs/tarkovy-app.png) |
| Logo | [`docs/tarkovy-logo.png`](docs/tarkovy-logo.png) |
| Icon (PNG) | [`docs/tarkovy-icon.png`](docs/tarkovy-icon.png) |
| App icon (`.ico`) | [`docs/tarkovy.ico`](docs/tarkovy.ico) · also `src/Tarkovy/Assets/brand/` |
...
<p align="center">
  <img src="docs/tarkovy-icon.png" alt="" width="40"/><br/>
